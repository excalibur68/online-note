...
$message .= "http://caoyan.thecompletewebhosting.com/resetpassword.php?user_id=$user_id&key=$key";
if(mail($email, 'Reset your password', $message, 'From:'.'caoyan200901@gmail.com')){
